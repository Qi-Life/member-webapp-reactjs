...
export const PaymentQuestion = [
  {
    question: 'Can I just listen to these, or do I need Qi Coils to use these frequencies?',
    answer:
  ...
  },
  {
    ...
    answer: 'Yes, all frequencies are tested and proven safe.',
  },
  {
    question: 'Are these frequencies safe?',
    answer:
      'For best practices in listening to the frequencies, both headsets or speakers are okay, but we recommend turning up your volume a little bit to help the frequency better penetrate your body (you can also listen to the frequencies at any time). Also, keep in mind that some frequencies are extremely low and not audible to the human ear but they are certainly having an effect.',
  },
  {
    question: 'Is sound and/or frequency therapy scientifically proven?',
    answer:
  ...
  {
    question: 'How Often Can I Use these frequencies?',
    answer:
  ...
  {
    question: 'When should I use these frequencies?',
    answer:
  ...
  {
    question: 'Can I use it while I sleep?',
    answer:
      'Yes you can, but make sure to secure it properly or place it on your bedside table to avoid accidentally damaging the wires or the device itself. Also, make sure that your frequencies are playing through the Qi Coil.',
  },
  {
  ...
  {
    question: 'What Can I Do to Maximize the Effects of Using these frequencies?',
    answer:
  ...
  {
    question: 'How do these frequencies work?',
    answer:
  ...
  {
    question: 'How Do I Use Quantum frequencies?',
    answer:
  ...
  {
    question: 'How Long Should I Use these frequencies for?',
    answer:
  ...
  {
    question: 'How long do the effects last for?',
    answer:
  ...
  {
    question: 'What is the difference between Rife, Quantum, Higher Quantum and Inner Circle frequencies?',
    answer:
  ...
  {
    question: 'Does it work for people who’ve never done this before?',
    answer:
  ...
  {
    question: 'How can I attract abundance or manifest my intentions with this?',
    answer:
  ...
  {
    question: 'What Is the frequency range and waveform?',
    answer:
  ...
  {
    question: 'What Can I Do If I’m Not Satisfied with the Product?',
    answer:
